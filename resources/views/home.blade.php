...
@section('content')
<div class="md:h-[98vh] w-screen mt-20 md:mt-8 mb-10 p-4 flex flex-col md:flex-row md:items-center md:justify-between box-border">
...
<div class="flex flex-col md:flex-row md:justify-between w-full md:w-3/5 gap-2">
  ...
  <div class="flex gap-2 bg-white shadow-md p-2 items-center rounded w-full"><img src="{{url('assets/images/testing-framework.svg')}}"><p>Automation Testing<p></div>
</div>
