    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link  {{ Request::is('admin/category') || Request::is('admin/create-category') || Request::is('admin/edit-category/*') || Request::is('admin/view-category') ? 'collapse active' : 'collapsed' }}"
                ...
                <div class="collapse {{ Request::is('admin/view-category') || Request::is('admin/create-category') || Request::is('admin/edit-category/*') ? 'show' : '' }}"
                    id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link {{ Request::is('admin/create-category') ? 'active' : '' }}"
                            href="{{ url('admin/create-category') }}">Add Category</a>
                        <a class="nav-link {{ Request::is('admin/view-category') ? 'active' : '' }}"
                            href="{{ url('admin/view-category') }}">View Category</a>
                    </nav>
                </div>
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePort"
                    aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                    Portfolio
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
